...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    private shopFormService: ShopFormService, private cartService: CartService) {}
  ...
  ngOnInit(): void {
    ...
    this.shopFormService.getCountries().subscribe(
      data => {
        console.log("Restrieved countries: " + JSON.stringify(data));
        this.countries = data;
      }
    );
  }
